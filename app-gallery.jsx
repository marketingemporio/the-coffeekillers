        ...
        <div className="wrap">
          ...
          <div className="split">
            <div className="rv">
              ...
              <p style={{ maxWidth: "44ch", color: "rgba(255,255,255,.75)", fontSize: "clamp(16px,2vw,20px)", marginTop: 16, lineHeight: 1.65 }}>
                Estratti dei nostri show. Per capire davvero come suoniamo, niente è meglio di vederci in azione.
              </p>
              <a className="btn" href="https://www.youtube.com/@thecoffeekillers" target="_blank" rel="noopener" style={{ marginTop: 24, background: "var(--ck-paper)", color: "#141414", borderColor: "var(--ck-paper)" }}>

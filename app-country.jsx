          ...
          <div className="co-split">
            <div className="co-text rv">
              ...
              <div className="tag-strip" style={{ marginTop: 20 }}>
                <span style={{ color: "rgba(255,255,255,.75)", borderColor: "rgba(255,255,255,.3)" }}>Line dance</span>
                <span style={{ color: "rgba(255,255,255,.75)", borderColor: "rgba(255,255,255,.3)" }}>Festival</span>
                <span style={{ color: "rgba(255,255,255,.75)", borderColor: "rgba(255,255,255,.3)" }}>Feste &amp; sagre</span>
                <span style={{ color: "rgba(255,255,255,.75)", borderColor: "rgba(255,255,255,.3)" }}>Locali</span>
                <span style={{ color: "rgba(255,255,255,.75)", borderColor: "rgba(255,255,255,.3)" }}>Eventi aziendali</span>
              </div>
            </div>
            <figure className="co-media rv rv--right">
